...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssAccordion = function() {
        ...
        function toggleAccordion(header) {
            ...
            // Toggle current accordion (no longer exclusive - multiple can be open)
            header.setAttribute('aria-expanded', !isExpanded);
            
            if (!isExpanded) {
                // Opening - set max-height to scrollHeight for smooth transition
   ...
   /* Blog Post Expand
    * ------------------------------------------------------ */
    const ssBlogExpand = function() {
        const expandButtons = document.querySelectorAll('.blog-post__expand-btn');
        ...
        expandButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                const content = post.querySelector('.blog-post__full-content');
